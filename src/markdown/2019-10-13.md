...
という感じになります。ここで 3番の工程だけ綺麗に解決できず、やむおえず力技ですが dev tool を開いて HTML を取得しています。。ここが一番このアプリケーションで心残りとなっている部分です。

ということで、少し無理やり感もありますが、このブログは GitHub を使って執筆しています。使ってみると超快適です。  
